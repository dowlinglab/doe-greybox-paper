...
def run_TC_Lab_experiment(Q1=None, Q2=None, time_points=None, t_jump=0.2):
    ...
    if Q1 is None and Q2 is None:
        raise ValueError(
            "Either Q1 or Q1 and Q2 must be defined to run a TC Lab experiment in this format. Please provide a list of power percentage values from 0 to 100 in the same length as the time_periods input."
        )
...
def automated_TC_Lab_model_identification(initial_datasets=None, n=2):
    ...
    for i in range(n):
        ...
        theta_current = TC_Lab_parameter_estimation(
            data_files=data_sets, generate_Th=False
        )
